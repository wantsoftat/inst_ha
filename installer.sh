...
URL_VERSION="https://raw.githubusercontent.com/wantsoftat/inst_ha/master/stable.json"
...
URL_APPARMOR_PROFILE="https://raw.githubusercontent.com/wantsoftat/inst_ha/master/apparmor.txt"
